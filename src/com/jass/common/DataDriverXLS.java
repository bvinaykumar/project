 ...
 * Description: Excel sheet Reader
 *  **/
...
public class DataDriverXLS {
	...
	public DataDriverXLS(String path) {
	...
	public static void main(String arg[]) throws IOException {
		...
		DataDriverXLS datatable = null;

		datatable = new DataDriverXLS("‪C:\\Selenium\\Book1.xls");
		for (int col = 0; col < datatable.getColumnCount("Sheet1"); col++) {
			for (int row = 0; row < datatable.getRowCount("Sheet1"); row++) {

				System.out.print(datatable.getCellData("Sheet1", col, row)
						+ "\t");
			}
			System.out.println("");
		}
